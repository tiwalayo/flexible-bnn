...
parser.add_argument('--model', type=str, default='conv_mc', help='the model that we want to train')
...
parser.add_argument('--weight_decay', type=float,
                    default=0.00000, help='weight decay')
...
parser.add_argument('--save_last', action='store_true',
                    help='whether to just save the last model', default=True)                    
