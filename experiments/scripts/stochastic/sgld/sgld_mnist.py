...
parser.add_argument('--model', type=str, default='conv_sgld', help='the model that we want to train')

parser.add_argument('--learning_rate', type=float,
                    default=0.0005, help='init learning rate')
...
parser.add_argument('--weight_decay', type=float,
                    default=0.07, help='weight decay')
